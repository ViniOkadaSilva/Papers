...
clean_1872$pasture_workers <-
  100*(clean_1872$SomaDeSOMA_G_Criadores)/(clean_1872$SomaDeSOMA_L_Almas + clean_1872$SomaDeSOMA_E_Almas) 
...
```{r}
clean_1872$ten_leagues <- ifelse(clean_1872$coast_dist > 66.6, 1, 0)
...
clean_1872_NE <- subset(clean_1872,  abbrev_state %in% c("PB", "PE", "RN", "AL"))
...
ggplot(subset(clean_1872,  abbrev_state %in% c("PB", "PE", "RN", "AL") & coast_dist < 200), 
...
rdplot(x = clean_1872_donut$coast_dist, y = clean_1872_donut$free_slave, 
       binselect="es", ci=95, 
