...
\begin{frame}{\hypertarget{IV}Identification}{Instrumental Variable}
    ...
    \begin{outline}
        ...
        \vspace{2mm}
        \pause 
        \1 (Not a lot of Obs. $\Rightarrow$ I can double it if needed)
    \end{outline}
\end{frame}
...
\begin{frame}{Descriptive Maps}\hypertarget{maps}{}
    \begin{outline}
        ...
        \hyperlink{1872_gender}{\beamerbutton{Gender Ratios}}
        \vspace{3mm}
        \1 Graphs: \hyperlink{year_dist}{\beamerbutton{Size Distribution}} \hyperlink{year_dist_1697}{\beamerbutton{Size Distribution Pre and Post 1697}}
    \end{outline}
\end{frame}

\begin{frame}{Descriptive Maps - Grid Level}\hypertarget{grid_maps}{}
    \begin{outline}
        \1 Sugarcane:
...
\begin{frame}{Tables and Results}\hypertarget{tables}{}
    \begin{outline}
        ...
        \vspace{3mm}
        \1 OLS Results:
        \hyperlink{econ_activities}{\beamerbutton{Economic Activity}} 
...
\begin{frame}{
    ...
    \hyperlink{tables}{\beamerbutton{Back}}}
    \centering
...
\begin{frame}
    {Balance Tables \hyperlink{maps}{\beamerbutton{Back}}}
